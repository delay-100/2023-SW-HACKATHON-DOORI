...
import com.doori.hackerthon.exception.BadRequestException;
import com.doori.hackerthon.exception.FileWriteException;
import com.doori.hackerthon.exception.GCPFileUploadException;
import com.doori.hackerthon.exception.InvalidFileTypeException;
...
//            RandomString id = new RandomString(6, ThreadLocalRandom.current());
            ...
            Blob blob = bucket.create(gcpDirectoryName + "/" + fileName + "-" + uuid + checkFileExtension(fileName), fileData, contentType);
